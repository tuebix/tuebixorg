...
layout: talk
title:
url: /2026/programm/187-what-does-it-take-to-run-a-linux-distribution-eine-ubersicht-uber-die-infrastruktur-von-arch-linux/
weight:
menu:
---
## What does it take to run a Linux distribution? - Eine Übersicht über die Infrastruktur von Arch Linux

### <img height = "32" src="../../../images/talk.svg"> 12:30 bis 13:20 in Raum V1 (F119)
...
Ich bin Christian und arbeite bei einigen OpenSource Projekten mit, zum Beispiel bei [Arch Linux](https://archlinux.org/) und bei [Kubeflow](https://github.com/kubeflow/) sowohl als Entwickler, für DevOps & Infrastrukturmanagement, als auch in verschiedenen Communityrollen (Main Signing Key, Bug Wrangler, Mediator etc.).
...
- [LinkedIn](https://www.linkedin.com/in/christian-heusel/)
- [Arch Linux Gitlab](https://gitlab.archlinux.org/gromit/)
